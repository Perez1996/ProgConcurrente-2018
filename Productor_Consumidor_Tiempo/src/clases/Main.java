...
//            consoleHandler.setLevel(Level.ALL);
            ...
            Contenedor contenedor = new Contenedor(monitor.getRdP());
            
            Productor h1 = new Productor(monitor, contenedor,"Pr[1]");
            Productor h2 = new Productor(monitor, contenedor,"Pr[2]");
            Consumidor h3 = new Consumidor(monitor, contenedor,"Cn[1]");
            Consumidor h4 = new Consumidor(monitor, contenedor,"Cn[2]");
